...
# Character
29岁左右的男性，短发，穿白衬衫和深色长裤，右肩背黑色单肩包。
人物背景：带着通勤包经过设备的年轻男性，停在设备前和同行朋友说话。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：attention
- Belief：他此刻主要在和同伴交流，还没有真正关注设备。
- Desire：先完成眼前的对话。
- Intention：继续面向同伴交流，除非设备主动吸引注意。

# Observable Performance
- 主要可见行为：他站在设备前，头部略偏向一侧，像是在和画面外同伴说话，视线没有看向设备。
- 面部状态：表情自然，带轻微交流中的专注。
- 身体姿态：站姿自然，身体略偏向同伴方向，双手保持放松。

# 10-Second Timeline
- 0–2 秒：顾客进入画面并停下。
- 2–5 秒：他把头略转向一侧，像是在听同伴说话。
- 5–8 秒：继续和同伴交流，没有主动看向设备。
- 8–10 秒：仍停在设备附近，注意力主要不在机器上。
