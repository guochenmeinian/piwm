...
# Character
23岁左右的男性，短发，穿白色T恤和深色休闲裤，手里拿着手机。
人物背景：午休时独自看商品的年轻男性，已经在顺畅地自行比较。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：interest
- Belief：他已经能从当前信息中继续自行判断。
- Desire：想保留自主比较空间，不想被额外打断。
- Intention：继续按自己的节奏观察并形成偏好。

# Observable Performance
- 主要可见行为：他的视线在少数几个区域之间缓慢切换，每次都有自然停留，没有明显卡住。
- 面部状态：神情专注平和，没有焦虑或困惑。
- 身体姿态：身体正面朝向设备，上半身轻微前倾，动作克制稳定。

# 10-Second Timeline
- 0–2 秒：顾客已经停在设备前。
- 2–5 秒：他缓慢查看不同位置。
- 5–8 秒：视线继续自然切换，比较过程顺畅。
- 8–10 秒：保持专注浏览，没有寻求帮助。
