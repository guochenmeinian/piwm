...
# Character
28岁左右的男性，短发，穿深色夹克和白色内搭，手里拿着手机。
人物背景：已经基本形成偏好的年轻男性，正在做最后自我确认。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：desire
- Belief：他认为目标商品已经比较符合自己的需要。
- Desire：想再自行确认片刻，然后完成决定。
- Intention：继续安静确认，不需要额外推动。

# Observable Performance
- 主要可见行为：他长时间看向同一位置，偶尔做很轻的视线调整，整体状态稳定。
- 面部状态：神情专注而平静，犹豫程度很低。
- 身体姿态：身体轻微前倾，双手自然放在身前。

# 10-Second Timeline
- 0–2 秒：顾客已经锁定目标方向。
- 2–5 秒：他保持稳定注视。
- 5–8 秒：只做轻微视线变化，没有再看其他候选。
