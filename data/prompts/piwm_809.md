...
# Character
24岁左右的女性，齐肩黑发，穿米白色衬衫和浅色半裙，手里拿着手机。
人物背景：刚走近设备的年轻女性，停在附近整理包带和手机。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：attention
- Belief：她还没有把当前注意力放到设备上。
- Desire：先整理好手里的物品。
- Intention：继续处理手头动作，之后再决定看向哪里。

# Observable Performance
- 主要可见行为：她停在设备附近，一手整理包带，一手拿着手机，视线主要落在手部动作上。
- 面部状态：表情自然平静，注意力在整理动作上。
- 身体姿态：身体正面朝向镜头，站姿稳定但较为放松。

# 10-Second Timeline
- 0–2 秒：顾客走近并停在镜头中央。
- 2–5 秒：她低头整理肩上的包带。
- 5–8 秒：手里手机轻微调整，视线仍没有看向设备。
- 8–10 秒：继续停留在设备附近，但注意力仍在手头事务上。
