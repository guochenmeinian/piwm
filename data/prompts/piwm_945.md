...
- Intention：围绕当前偏好做最后权衡，并对 Recommend:soft 类型响应保持开放。

# Observable Performance
- 主要可见行为：顾客已经停留较久，视线集中在一个候选区域，仍保留轻微犹豫。整体动作缓慢、连续、真实，没有夸张表演。
- 面部状态：表情自然克制，带有轻微思考或确认感，没有明显焦躁、惊讶或防御。
- 身体姿态：身体正面对向设备，站姿稳定，双手自然放在手机、包带或设备前方可见区域。

# 10-Second Timeline
- 0–2 秒：顾客进入或已经停留在设备前方，视线先稳定看向前方区域。
- 2–5 秒：顾客继续已经停留较久，视线集中在一个候选区域，仍保留轻微犹豫，头部和视线变化幅度较小。
