...
# Character
27岁左右的女性，长发扎低马尾，穿浅绿色针织衫和牛仔裤。
人物背景：已经自然开始浏览的年轻女性，当前并不需要设备主动介入。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：interest
- Belief：她认为设备里可能有合适商品，正在按自己的节奏了解。
- Desire：想先自主看看不同信息，再决定是否深入比较。
- Intention：继续安静浏览，不希望当前节奏被打断。

# Observable Performance
- 主要可见行为：她的视线在前方几个区域之间稳定切换，节奏从容，没有明显困惑或求助信号。
- 面部状态：表情放松专注，情绪平稳。
- 身体姿态：身体轻微前倾，双肩放松，站姿稳定。

# 10-Second Timeline
- 0–2 秒：顾客已站定并看向前方。
- 2–5 秒：她自然查看不同区域，节奏平稳。
- 5–8 秒：继续自主浏览，没有出现明显犹豫升级。
- 8–10 秒：保持原有节奏，仍在独立观察。
