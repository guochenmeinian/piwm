...
# Character
26岁左右的女性，黑色中长发，穿米白色衬衫和浅灰色长裤。
人物背景：正在从容浏览的年轻女性，当前不需要额外帮助。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：interest
- Belief：她已经能够根据当前信息继续自行判断。
- Desire：想保留自然浏览的节奏。
- Intention：继续独立查看，不希望被打断。

# Observable Performance
- 主要可见行为：她在几个区域之间稳定查看，视线切换自然，动作从容，没有困惑表现。
- 面部状态：表情放松而专注。
- 身体姿态：身体略微前倾，站姿稳定。
