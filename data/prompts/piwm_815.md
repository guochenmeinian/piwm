...
# Character
27岁左右的男性，短黑发，穿浅蓝色衬衫和深色长裤，肩背黑色双肩包。
人物背景：刚从走廊经过的年轻男性，在设备前停顿整理手机消息。

# Internal State Reference
这些状态只用于约束行为气质，不应直接以文字、符号或 UI 出现在画面里。
- 购买阶段：attention
- Belief：他还没有真正开始关注设备内容。
- Desire：先处理手机上的消息。
- Intention：继续看手机，之后再决定是否关注周围。

# Observable Performance
- 主要可见行为：他停在设备前，低头查看手机，手指有轻微操作，没有抬头看向机器。
- 面部状态：神情平稳，注意力集中在手机上。
- 身体姿态：身体朝向设备，肩膀放松，站姿自然。

# 10-Second Timeline
- 0–2 秒：顾客经过后停在设备附近。
- 2–5 秒：他低头查看手机消息。
- 5–8 秒：手指轻微滑动，仍未抬头。
- 8–10 秒：继续停留原地，注意力还在手机上。
