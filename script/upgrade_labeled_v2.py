#!/usr/bin/env python3
"""Backfill PIWM v2.2 action/terminal-realization fields into labeled JSON files."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backfill v2.2 action/realization fields in data/labeled/*.json.")
