...
当前 schema 已同步 PIWM v2：旧 `candidate_actions / best_action` 继续保留，新增 `dialogue_act / act_params / co_acts / realization` 和 outcome 级 `terminal_realization`。
...
| `dialogue_act / act_params / co_acts` | yes | best action 的 v2 policy 字段 |
